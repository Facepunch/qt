...
(: the first node of the first operand against various   :)
...
and ($input-context1/works[1]/employee[1]/empnum[1] << $input-context2/staff[1]/employee[2]/empnum[1])
and ($input-context1/works[1]/employee[1]/empnum[1] << $input-context2/staff[1]/employee[3]/empnum[1]))
or
(($input-context1/works[1]/employee[1]/empnum[1] >> $input-context2/staff[1]/employee[1]/empnum[1])
and ($input-context1/works[1]/employee[1]/empnum[1] >> $input-context2/staff[1]/employee[2]/empnum[1])
and ($input-context1/works[1]/employee[1]/empnum[1] >> $input-context2/staff[1]/employee[3]/empnum[1]))
